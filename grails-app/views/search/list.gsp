	...
	<![endif]-->
		...
		<script type="text/javascript" charset="utf-8">
			...
			var pageData = {
				...
				GVAPI: {
			    	resultsUrl: "${createLink(controller:'GVAPISearch',action:'GVsearch', params:[text: session.searchFilter.getExternalTerms()])}"
			    },
			    GVAPI2: {
			    	resultsUrl: "${createLink(controller:'GVAPISearch2',action:'GVsearch2', params:[text: session.searchFilter.getExternalTerms()])}"
			    }
